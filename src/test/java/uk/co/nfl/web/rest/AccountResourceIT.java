...
import uk.co.nfl.config.Constants;
import uk.co.nfl.domain.Authority;
import uk.co.nfl.domain.User;
import uk.co.nfl.repository.AuthorityRepository;
import uk.co.nfl.repository.UserRepository;
import uk.co.nfl.security.AuthoritiesConstants;
import uk.co.nfl.service.MailService;
import uk.co.nfl.service.UserService;
import uk.co.nfl.service.dto.PasswordChangeDTO;
import uk.co.nfl.service.dto.UserDTO;
import uk.co.nfl.web.rest.errors.ExceptionTranslator;
import uk.co.nfl.web.rest.vm.KeyAndPasswordVM;
import uk.co.nfl.web.rest.vm.ManagedUserVM;
