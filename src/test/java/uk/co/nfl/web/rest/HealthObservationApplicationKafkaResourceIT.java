...
import uk.co.nfl.service.HealthObservationApplicationKafkaConsumer;
...
public class HealthObservationApplicationKafkaResourceIT {
    ...
    @Autowired
    private HealthObservationApplicationKafkaProducer producer;

    @Autowired
    private HealthObservationApplicationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        HealthObservationApplicationKafkaResource kafkaResource = new HealthObservationApplicationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/health-observation-application-kafka/publish?message=test"))
