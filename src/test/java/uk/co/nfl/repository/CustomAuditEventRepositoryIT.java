...
import uk.co.nfl.config.audit.AuditEventConverter;
import uk.co.nfl.domain.PersistentAuditEvent;
...
import static uk.co.nfl.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
